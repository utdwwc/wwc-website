...
export default class Membership extends Component {
        render() {
			...
			<h5>Membership FAQs</h5><br></br>
			</Jumbotron>
                        <Jumbotron className="jumbotron-infobox">
		        <h2>
                        <question>How do I become a member of Women Who Compute?</question><br></br>
			<answer>Attend our events! There is no formal membership process, so we encourage memberhsip by active particpation in our events.</answer><br></br><br></br>
                        <question>I am not a woman- am I still eligible to become a member of Women Who Compute?</question><br></br>
			<answer>While WWC aims to promote the idea of women in technology, membership is open to all undergraduate and graduate students attending the University of Texas at Dallas!</answer><br></br><br></br>
			<question>Do I have to pay an annual membership fee?</question><br></br>
			...
			<question>Do I have to attend every WWC event to be a member?</question><br></br>
			...
			<question>How do I stay updated with WWC events?</question><br></br>
